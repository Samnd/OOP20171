...
public class CreditAccount extends Account {
    ...
    public static final double transferRate = 0.3;


    public CreditAccount(int dateCreated, double limit, double creditInterest, double debitInterest, double balance, String name) {
        super(name, balance);
        this.limit = limit;
...
//            System.out.println("Rút thành công");
    ...
    public void inThongTin(){
        ...
        System.out.println("Hạn mức: " + this.limit + ", lãi suất gửi" + this.debitInterest + ", lãi suất ghi nợ " + this.creditInterest);
        System.out.println("Phương thức của Credit Acount.");
    }
